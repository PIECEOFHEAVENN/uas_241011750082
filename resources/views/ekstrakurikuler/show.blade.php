...
<div class="card border-0 shadow-sm">
    ...
    <div class="card-body">
        <div class="row">
            <div class="col-md-4 text-center">@if($ekstrakurikuler->gambar)<img src="{{ asset($ekstrakurikuler->gambar) }}" class="img-fluid rounded" style="max-height:250px;object-fit:contain;">@else<div class="bg-light p-5 rounded"><i class="bi bi-image display-1 text-muted"></i></div>@endif</div>
